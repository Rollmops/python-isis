...
BOOST_PYTHON_MODULE( _util )
{
	...
	.def( "__iter__", iterator<isis::util::fvector3>() )
	.def( "__str__", &_Vector3<float>::_toString )
	...
	.def( "__iter__", iterator<isis::util::dvector3>() )
	...
	.def( "__str__", &_Vector4<float>::_toString )
	...
	.def( "__str__", &_Vector4<int32_t>::_toString )
